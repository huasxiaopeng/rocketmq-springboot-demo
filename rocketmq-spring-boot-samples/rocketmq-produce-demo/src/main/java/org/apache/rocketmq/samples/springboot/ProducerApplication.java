...
//      //01发送，字符串消息  同步发送
        SendResult oneTopicsend = rocketMQTemplate.syncSend(oneTopic, "hellorocket");
        System.out.printf("syncSend1 to topic %s sendResult=%s %n", oneTopic, oneTopicsend);
...
//        // Send user-defined object  传递明确的对象。并且带回调
...
//        // Send a batch of strings 发送批量消息
           testBatchMessages();
//
//        // Send transactional messages using rocketMQTemplate  发送事务 消息
